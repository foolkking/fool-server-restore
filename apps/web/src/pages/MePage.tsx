...
const text = {
  zh: {
    ...
    disconnected: "未连接",
    connectBtn: "连接",
    privacyNote: "环境保留只对虚拟机执行只读采集，不会修改目标系统；生成的重建 Playbook 仅保存在你的账户下。",
    installCommand: "安装命令",
  ...
  en: {
    ...
    connectBtn: "Connect",
    privacyNote: "Capture only performs read-only collection on the VM; the generated rebuild Playbook is saved to your account only.",
