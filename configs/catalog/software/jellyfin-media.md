...
开源媒体流媒体服务器，自托管 Netflix 替代品。

*Open-source media streaming server, self-hosted Netflix alternative.*

## 你将得到什么

- 📦 **jellyfin** _(Jellyfin)_ — 通过 apt
...
```bash
# 检查包是否已安装
dpkg -l | grep jellyfin      # Ubuntu/Debian
rpm -q jellyfin                # RHEL/CentOS/Anolis
