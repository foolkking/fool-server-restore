...
Cockpit 浏览器管理面板，可视化管理服务器。

*Cockpit browser-based server management panel.*

## 你将得到什么

- 📦 **cockpit** _(Cockpit)_ — 通过 apt
...
3. Verify Cockpit (port 9090)

## 验证安装

```bash
# 检查包是否已安装
dpkg -l | grep cockpit      # Ubuntu/Debian
rpm -q cockpit                # RHEL/CentOS/Anolis
