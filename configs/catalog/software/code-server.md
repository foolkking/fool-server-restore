...
在浏览器中运行的 VSCode，支持远程开发。

*VSCode in browser, supports remote development.*

## 你将得到什么

- ▶ **安装 code-server** _(Install code-server)_ — 通过 curl script
...
2. Enable code-server for current user
3. Verify code-server
