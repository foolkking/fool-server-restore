...
rsync、rclone、borgbackup、restic 等备份工具。

*rsync, rclone, borgbackup, restic backup tools.*

## 你将得到什么

- 📦 **rsync** _(rsync)_ — 通过 apt
- 📦 **rclone** _(rclone)_ — 通过 apt
...
```bash
# 检查包是否已安装
dpkg -l | grep rsync      # Ubuntu/Debian
rpm -q rsync                # RHEL/CentOS/Anolis
